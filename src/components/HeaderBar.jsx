...
const HeaderBar = () => {
  return (
    <header className="sticky top-0 z-20 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70 shadow-[0_4px_14px_rgba(0,0,0,0.07)]">
      <div className="mx-auto max-w-[1400px] px-6 py-3 flex items-center gap-6">
        {/* Brand */}
        <div className="flex items-center gap-3 min-w-[220px]">
          <div className="h-8 w-8 rounded-md bg-gradient-to-br from-[#2F3BAF] to-[#5064D8] shadow" />
        ...
        <div className="relative w-full max-w-xl hidden md:block">
          ...
          <input
            ...
            className="w-full rounded-md pl-10 pr-4 py-2.5 bg-[#F4F6FA] text-[#1B1D22] placeholder-[#5D6471] outline-none focus:ring-2 focus:ring-[#5064D8]/40 border border-[#D8DFEA]"
          />
        </div>

        {/* Actions */}
        <div className="flex items-center gap-4 ml-auto">
          <button className="relative rounded-md p-2 text-[#1B1D22] hover:bg-[#F4F6FA] transition">
            <Bell size={20} />
